...
function buildChatCommands(): ChatCommandDefinition[] {
  const commands: ChatCommandDefinition[] = [
    ...
    defineChatCommand({
      key: "qstatus",
      nativeName: "qstatus",
      description: "Show the active quick research job status for this chat.",
      textAlias: "/qstatus",
      acceptsArgs: false,
      category: "tools",
      argsParsing: "none",
    ...
    defineChatCommand({
      key: "qlast",
      nativeName: "qlast",
      description: "List recent quick research jobs for this chat.",
      textAlias: "/qlast",
      acceptsArgs: false,
      category: "tools",
      argsParsing: "none",
    ...
    defineChatCommand({
      key: "qretry",
      nativeName: "qretry",
      description: "Retry the latest failed quick research job, or a specific job id.",
      textAlias: "/qretry",
      acceptsArgs: true,
      category: "tools",
      args: [
        {
          name: "job_id",
          description: "Optional failed quick research job id",
          type: "string",
        },
      ],
    }),
