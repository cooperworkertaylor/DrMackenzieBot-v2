...
export function buildResearchServiceEnvironment(params: {
  env: Record<string, string | undefined>;
  ...
  return {
    ...
    OPENCLAW_STATE_DIR: stateDir,
    OPENCLAW_CONFIG_PATH: configPath,
    OPENCLAW_RESEARCH_DB_PATH: env.OPENCLAW_RESEARCH_DB_PATH,
    OPENCLAW_HOST_ROLE: env.OPENCLAW_HOST_ROLE,
    OPENCLAW_ALLOW_BROWSER: env.OPENCLAW_ALLOW_BROWSER,
    OPENCLAW_CHROME_PATH: env.OPENCLAW_CHROME_PATH,
